# ====================================================================================
# Setup Project
PROJECT_NAME := provider-collateprovider
...
IMAGES = provider-collateprovider
...
XPKGS = provider-collateprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-collateprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider CollateProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider CollateProvider controllers
...
# This target prepares repo for your provider by replacing all "collateprovider"
